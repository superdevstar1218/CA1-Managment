...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <link href="{{ asset('material') }}/css/bootstrap-multiselect.css" rel="stylesheet" type="text/css" />

    <link href="{{asset('material')}}/js/lib/main.css" rel='stylesheet' />
    ...
    <body class="{{ $class ?? '' }}">
        @auth()
            ...
            @if (Auth::user()->role == 1)
              @include('layouts.page_templates.subadmin')
            @endif
            @if (Auth::user()->role == 0)
        ...
        <script src="{{ asset('material') }}/js/bootstrap-multiselect.js"></script>
        @stack('js')
    </body>
</html>